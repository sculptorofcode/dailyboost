...
class _ProfileScreenState extends State<ProfileScreen> with SingleTickerProviderStateMixin {
                    ...
                    return Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          //   {'title': 'Device ID', 'value': profile?.deviceId ?? 'Unknown'},
                          //   {'title': 'Model', 'value': profile?.deviceModel ?? 'Unknown'},
                          //   {'title': 'Operating System', 'value': profile?.deviceOS ?? 'Unknown'},
                          // ], isDarkMode),
                          // const SizedBox(height: 20),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              TextButton.icon(
                                ...
                                label: Text(_isUpdatingLocation ? 'Updating...' : 'Update'),
                              ),
                            ],
                          ),
                          const SizedBox(height: 12),
                          ...
                          const SizedBox(height: 12),
                          _buildInfoCard(context, [
                            {'title': 'Last Active', 'value': _formatTimestamp(profile?.lastActive)},
                            {'title': 'Account Created', 'value': _formatTimestamp(profile?.createdAt)},
                          ], isDarkMode),
  ...
  Widget _buildProfileCard(BuildContext context, 
    User user, UserProfileModel? profile, bool isDarkMode) {
    return Card(
      elevation: 2,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(AppConstants.baseRadius),
  ...
  Widget _buildInfoCard(BuildContext context, List<Map<String, String>> items, bool isDarkMode) {
    return Card(
      elevation: 2,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(AppConstants.baseRadius),
  ...
  Widget _buildLocationCard(BuildContext context, UserProfileModel? profile, bool isDarkMode) {
